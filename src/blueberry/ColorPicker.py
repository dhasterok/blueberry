...
from PyQt6.QtWidgets import (
    QApplication, QWidget, QLabel, QVBoxLayout, QHBoxLayout, QPushButton, QSpinBox, QFileDialog, QScrollArea, QMessageBox
)
from PyQt6.QtGui import (
    QPixmap, QImage, QColor, QMouseEvent, QCursor, QPainter,
