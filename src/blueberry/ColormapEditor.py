...
class ColormapPreviewWidget(FigureCanvas):
    def __init__(self, plot_type="linear", parent=None):
        ...
        try:
            ...
            self.test_data = mpimg.imread(RESOURCE_PATH / "images" / "Heart_of_the_Phantom_Galaxy.jpg")
...
class ColormapEditorDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.picker.setMinimumHeight(360)  # Set minimum height for preview
    ...
    def set_axes_style(self, style):
        ...
        if style == "linear":
            ...
            self.colorblind_group.setFixedHeight(360)
